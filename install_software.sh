...
# Utils
sudo -E pacman -S --needed acpi compton cowsay dropbox dunst filezilla firefox gnupg gpa htop httpie keepassxc lolcat nitrogen playerctl ranger sysstat thunderbird tmux tree workrave xclip
