...
# Utils
sudo -E pacman -S --needed acpi cowsay dmenu dropbox dunst feh filezilla firefox gnupg gpa htop httpie keepassxc lolcat nitrogen playerctl ranger sysstat thunderbird tmux tree w3m workrave xclip
