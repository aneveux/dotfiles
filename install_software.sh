...
# Utils
sudo -E pacman -S --needed cowsay dropbox dunst filezilla firefox gnupg gpa htop keepassxc lolcat nitrogen playerctl ranger thunderbird tmux tree workrave xclip
