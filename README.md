...
`sudo pacman -S ansible atom corkscrew docker docker-compose dropbox filezilla firefox git gvim keepass numix-manjaro-themes numix-reborn-icon-themes numix-themes pgadmin3 terminator thefuck thunderbird tmux tree vim yaourt zsh`
